...
public class FacebookTask {
    ...
    public void run(Account account, Map<String,Integer> tasks) throws InterruptedException {
        ...
        doTasks(driver,tasks.get("likePageFacebook"),URL.URL_DO_TASK_LIKE_PAGE_CHEO,"like_page");
        doTasks(driver,tasks.get("emotionFacebook"),URL.URL_DO_TASK_EMOTION_POST,"emotion_post");
